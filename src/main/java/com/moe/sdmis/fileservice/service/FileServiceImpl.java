...
//					studentPojo.setSectionId(handleInteger(nullCheck(studentObj.get("sectionId")).get("v")));
				...
				studentPojo.setStudentStateCode(nullCheck(studentObj.get("studentStateCode")).get("v"));
