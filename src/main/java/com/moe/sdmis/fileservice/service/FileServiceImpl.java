...
//						studentPojo.setImpairmentType(null)
					...
					if(studentPojo.getOoscYn()==2) {
						...
						studentPojo.setOoscMainstreamedYn(handleInteger(nullCheck(studentObj.get("ooscMainstreamedYn")).get("v")));
					}
					...
					studentPojo.setExamAppearedPyYn(handleInteger(nullCheck(studentObj.get("examAppearedPyYn")).get("v")));
					}
					
					if(studentPojo.getEnrStatusPY()==3 || studentPojo.getEnrStatusPY()==4 || studentPojo.getExamAppearedPyYn()==2) {
